...
public class Principal {
    ...
    private Optional<DatosLibros> buscarLibroPorTitulo() {
        ...
        //Usamos optional que nos arroja dos resultados posibles, y nos ofrece metodos
        Optional<DatosLibros> libroBuscado = datosBusqueda.resultados().stream()
                //Filtramos, convertimos a mayusculas y comparamos si se encuentra o no se encuentra
                .filter(l -> l.titulo().toUpperCase().contains(tituloLibro.toUpperCase()))
                //Busca la primera coincidencia y la trae
                .findFirst();
        //se evalua si el libro existe o no existe
    ...
    private void buscarYGuardarEnBBDD() {
        ...
        if (datos.isPresent()) {
            ...
            if (existe) {
                ...
                // Crear una nueva instancia de Libros con los datos del libro encontrado
    ...
    private void listarLibros() {
        // Listando los libros desde la base de datos (supongo que usas repositorio.findAll())
    ...
    private void listarAutores() {
        // Listando los autores desde la base de datos
    ...
    private void listarAutoresVivosPorDeterminadoAnio() {
        ...
        if (autoresVivos.isEmpty()) {
            ...
            for (Autores autor : autoresVivos) {
                ...
                // Mostrar los libros escritos por este autor
                if (autor.getLibro() != null) {
                    System.out.println("Libros escritos por " + autor.getNombre() + ":");
    ...
    public void topLibros() {
        ...
        if (top10Libros.isEmpty()) {
            ...
            for (int i = 0; i < top10Libros.size(); i++) {
                ...
                String autor = obtenerNombresAutores(libroEncontrado); // Reemplaza con tu lógica para obtener el nombre del autor
                String idioma = libroEncontrado.getIdiomas(); // Asume que tienes un método para obtener el idioma
